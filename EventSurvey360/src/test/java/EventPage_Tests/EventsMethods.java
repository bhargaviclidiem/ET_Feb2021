...

{
	...
	public void CreateEventPage(int row) throws Exception {
		...
		String AreYou = Helper.getData("CreateEventPage", row, 2);
	...
	public void EventDetailPage(int row) throws Exception {
		...
		objIndexPage.EventNameTxt.sendKeys(Helper.getData("CreateEventPage", row, 3));
		Thread.sleep(2000);
...
//		objIndexPage.EventRdBtn(Helper.getData("CreateEventPage", row, 4));
		...
		String EventRadioBtn = Helper.getData("CreateEventPage", row, 4);
				
				if (EventRadioBtn.contains("Public")){
					
					objIndexPage.EventPublicRdBtn.click();
					
				} else if (EventRadioBtn.contains("Private")) {
					
					objIndexPage.EventPrivateRdBtn.click();
				}

		String OnlineEvnet = Helper.getData("CreateEventPage", row, 5);

		if (OnlineEvnet.equals("Yes")) {
			objIndexPage.EventNo.click();
			objIndexPage.EventURL.sendKeys(Helper.getData("CreateEventPage", row, 6));
		}

		else

		{
			objIndexPage.LocationTxt.sendKeys(Helper.getData("CreateEventPage", row, 7));
			objIndexPage.LocationTxt.click();
			objIndexPage.EventVenueTxt.sendKeys(Helper.getData("CreateEventPage", row, 8));
		}

		((JavascriptExecutor) driver).executeScript("scroll(0, 300);");

		objIndexPage.EventTypeDrp(Helper.getData("CreateEventPage", row, 9));
		objIndexPage.eventCategoriesDrpDwn(Helper.getData("CreateEventPage", row, 10));

		((JavascriptExecutor) driver).executeScript("scroll(0, -1000);");

		objIndexPage.OrganizerNameTxtBx.clear();
		objIndexPage.OrganizerNameTxtBx.sendKeys(Helper.getData("CreateEventPage", row, 11));
		//objIndexPage.OrganizerEmailidTxtBx.clear();
	//	objIndexPage.OrganizerEmailidTxtBx.sendKeys(Helper.getData("CreateEventPage", row, 12));
		objIndexPage.OrganizerPhoneTxt.clear();
		objIndexPage.OrganizerPhoneTxt.sendKeys(Helper.getData("CreateEventPage", row, 13));
		objIndexPage.OrganizerWebsiteTxt.clear();
		objIndexPage.OrganizerWebsiteTxt.sendKeys(Helper.getData("CreateEventPage", row, 14));

		Thread.sleep(2000);
		((JavascriptExecutor) driver).executeScript("window.scrollTo(0, 800)");
		Thread.sleep(2000);
		objIndexPage.OrganizerDescriptionTxt.clear();
		objIndexPage.OrganizerDescriptionTxt.sendKeys(Helper.getData("CreateEventPage", row, 15));

//		((JavascriptExecutor) driver).executeScript("window.scrollTo(0, -800)");
//
//		objIndexPage.ImageLnk.sendKeys(Helper.getData("CreateEventPage", row, 16));
...
//		objIndexPage.OrganizerTwitterTxt.sendKeys(Helper.getData("CreateEventPage", row, 20));
		...
		objIndexPage.EventTimeZoneDrpDwn.sendKeys(Helper.getData("CreateEventPage", row, 31));
	//	objIndexPage.EventDays(Helper.getData("CreateEventPage", row, 34));

		((JavascriptExecutor) driver).executeScript("window.scrollTo(0, 1000)");
		Thread.sleep(2000);
		String EventDays = Helper.getData("CreateEventPage", row, 34);

		if (EventDays.equals("One day")) {
			objIndexPage.OneDayEvent.click();
			objIndexPage.Date.clear();
			objIndexPage.Date.sendKeys(Helper.getData("CreateEventPage", row, 35));
			objIndexPage.StartTime.clear();
			objIndexPage.StartTime.sendKeys(Helper.getData("CreateEventPage", row, 36));
			objIndexPage.EndTime.clear();
			objIndexPage.EndTime.sendKeys(Helper.getData("CreateEventPage", row, 37));
			
			((JavascriptExecutor) driver).executeScript("window.scrollTo(0, 500)");
		} else if (EventDays.equals("Multiple days event")) {
			objIndexPage.MultipleDaysEvent.click();
			objIndexPage.Date1.sendKeys(Helper.getData("CreateEventPage", row, 39));
			//objIndexPage.StartTime1.click();
		objIndexPage.StartTime1.clear();
			objIndexPage.StartTime1.sendKeys(Helper.getData("CreateEventPage", row, 40));
			//objIndexPage.EndTime1.click();
			objIndexPage.EndTime1.clear();
			objIndexPage.EndTime1.sendKeys(Helper.getData("CreateEventPage", row, 41));
			objIndexPage.PlusAddBtn.click();
			Thread.sleep(2000);
			((JavascriptExecutor) driver).executeScript("window.scrollTo(0, 1000)");
			Thread.sleep(2000);
			objIndexPage.Date2.sendKeys(Helper.getData("CreateEventPage", row, 42));
			objIndexPage.StartTime2.clear();
			objIndexPage.StartTime2.sendKeys(Helper.getData("CreateEventPage", row, 43));
			objIndexPage.EndTime2.clear();
			objIndexPage.EndTime2.sendKeys(Helper.getData("CreateEventPage", row, 44));
	...
	Thread.sleep(2000);
	objIndexPage.EventDescriptionTxt.sendKeys(Helper.getData("CreateEventPage", row, 79));
	}

	public void EventDetailPageEventTicket(int row) throws Exception {

		objIndexPage.EventTicket.sendKeys(Helper.getData("CreateEventPage", row, 21));
	...
	public void EventOptionsPage(int row) throws Exception {
		...
		// 32));
		objIndexPage.TagsTxt.sendKeys(Helper.getData("CreateEventPage", row, 30));
		
		objIndexPage.SponsorCategoriesDrpDwn(Helper.getData("CreateEventPage", row, 33));
	...
	public void EventOptionSaveAndPublish() throws Exception {
...
//agenda all types
	...
	public void EventAgendasPageallTypes(int row) throws Exception {
		...
		String AgendasRadioBtn = (Helper.getData("CreateEventPage", row, 45));
		...
		if (AgendasRadioBtn.contains("Sponsor")) {
			...
			objIndexPage.SponsorPackage.sendKeys(Helper.getData("CreateEventPage", row, 46));
Thread.sleep(2000);
...
//Thread.sleep(2000);
	...
	public void EventAgendasPageTypes(int row) throws Exception {
		...
		String AgendasRadioBtn = (Helper.getData("CreateEventPage", 2, 45));
		...
		if (AgendasRadioBtn.contains("Sponsor")) {
			...
			Thread.sleep(5000);
			objIndexPage.AgendaPageAddnewBtn.click();
			objIndexPage.SponsorPackage.sendKeys(Helper.getData("CreateEventPage", 2, 46));
	...
	public void EventSponsorPage(int row) throws Exception {
		...
		objIndexPage.RoomNumber.sendKeys(Helper.getData("CreateEventPage", 2, 47));
		objIndexPage.SessionTypeDrp.click();
		Thread.sleep(2000);
		objIndexPage.SessionTypeDrpAddBtn.click();
		Thread.sleep(2000);
		objIndexPage.AddSessionTypeTxtBx.sendKeys(Helper.getData("CreateEventPage", 2, 83));
		Thread.sleep(2000);
		...
		((JavascriptExecutor) driver).executeScript("scroll(0, 450);");
		 objIndexPage.TopicDateDrpDwn(Helper.getData("CreateEventPage", row, 50));
		// ((JavascriptExecutor) driver).executeScript("scroll(0, 300);");
		...
		// 2, 52));
		((JavascriptExecutor) driver).executeScript("scroll(0, -900);");
		objIndexPage.Title.sendKeys(Helper.getData("CreateEventPage", row, 53));
		objIndexPage.TopicDescription.sendKeys(Helper.getData("CreateEventPage", row, 54));
		Random rand = new Random();
		int n = rand.nextInt(5000) + 1;
		((JavascriptExecutor) driver).executeScript("scroll(0, 500);");
		objIndexPage.EasySearchCode.sendKeys(Helper.getData("CreateEventPage", row, 55) + n);
		 //objIndexPage.TopicsSurveyDrpDwn(Helper.getData("CreateEventPage",row,
		 //56));
		
		objIndexPage.SponsorCompanyNameDrpDwn.sendKeys(Helper.getData("CreateEventPage", row, 57));
	...
	public void EventSecondSponsorPage(int row) throws Exception {
		...
		//Thread.sleep(2000);
		objIndexPage.RoomNumber.clear();
		objIndexPage.RoomNumber.sendKeys(Helper.getData("CreateEventPage", 3, 47));
		//objIndexPage.SessionTypeDrp.click();
		Thread.sleep(2000);
	//	objIndexPage.SessionTypeDrpAddBtn.click();
		//Thread.sleep(2000);
		//objIndexPage.AddSessionTypeTxtBx.sendKeys(Helper.getData("CreateEventPage", 3, 83));
		Thread.sleep(2000);
		//objIndexPage.AddSessionTypeBtn.click();
		Thread.sleep(2000);
		((JavascriptExecutor) driver).executeScript("scroll(0, 350);");
		objIndexPage.SessionTypeDrp(Helper.getData("EventStaging", 2, 83));
		Thread.sleep(2000);
		//((JavascriptExecutor) driver).executeScript("scroll(0, 450);");
		Thread.sleep(2000);
		 objIndexPage.TopicDateDrpDwn1(Helper.getData("CreateEventPage", row, 50));
		// ((JavascriptExecutor) driver).executeScript("scroll(0, 300);");
		// objIndexPage.TopicsStartTime.sendKeys(Helper.getData("CreateEventPage",
		// 2, 51));
		// objIndexPage.TopicsEndTime.sendKeys(Helper.getData("CreateEventPage",
		// 2, 52));
		((JavascriptExecutor) driver).executeScript("scroll(0, -900);");
		objIndexPage.Title.sendKeys(Helper.getData("CreateEventPage", 3, 53));
		objIndexPage.TopicDescription.sendKeys(Helper.getData("CreateEventPage", 3, 54));
		Random rand = new Random();
		int n = rand.nextInt(5000) + 1;
		((JavascriptExecutor) driver).executeScript("scroll(0, 500);");
		objIndexPage.EasySearchCode.sendKeys(Helper.getData("CreateEventPage", 3, 55) + n);
		 //objIndexPage.TopicsSurveyDrpDwn(Helper.getData("CreateEventPage",row,
		 //56));
		
		objIndexPage.SponsorCompanyNameDrpDwn.sendKeys(Helper.getData("CreateEventPage", 3, 57));
		((JavascriptExecutor) driver).executeScript("scroll(0, 600);");
		//objIndexPage.Sponsorlogo.sendKeys(Helper.getData("CreateEventPage", row, 58));
		((JavascriptExecutor) driver).executeScript("scroll(0, 500);");
		Thread.sleep(1000);
	...
	public void EventAgendaPage(int row) throws Exception {
		...
		//Thread.sleep(2000);
		objIndexPage.RoomNumber.clear();
		objIndexPage.RoomNumber.sendKeys(Helper.getData("CreateEventPage", row, 47));
		((JavascriptExecutor) driver).executeScript("scroll(0, 300);");
		objIndexPage.SessionTypeDrp.click();
		...
		((JavascriptExecutor) driver).executeScript("scroll(0, 600);");
		Thread.sleep(2000);
		objIndexPage.AgendaCompanyName(Helper.getData("CreateEventPage", row, 88));
...
//		objIndexPage.SponsorLogoImageCropBtn.click();
	...
	public void EventExhibitorPage(int row) throws Exception {
		...
		objIndexPage.SelectExhibitorPackage(Helper.getData("CreateEventPage", 2, 86));
		//objIndexPage.AgendaPageAddnewBtn.click();
		Thread.sleep(2000);
		objIndexPage.RoomNumber.clear();
		objIndexPage.RoomNumber.sendKeys(Helper.getData("CreateEventPage", row, 47));
		...
		objIndexPage.AddSessionTypeBtn.click();
		Thread.sleep(2000);
		objIndexPage.AddSessionTypeTxtBx.sendKeys(Helper.getData("CreateEventPage", row, 84));
		Thread.sleep(2000);
		objIndexPage.AddSessionTypeBtn.click();
		((JavascriptExecutor) driver).executeScript("scroll(0, 500);");
		Thread.sleep(2000);
		//objIndexPage.SessionTypeDrp(Helper.getData("CreateEventPage", row, 85));
		Thread.sleep(2000);
		 objIndexPage.TopicDateDrpDwn(Helper.getData("CreateEventPage", row, 50));
		// ((JavascriptExecutor) driver).executeScript("scroll(0, 300);");
		// objIndexPage.TopicsStartTime.sendKeys(Helper.getData("CreateEventPage",
		...
		((JavascriptExecutor) driver).executeScript("scroll(0, -900);");
		objIndexPage.Title.sendKeys(Helper.getData("CreateEventPage", row, 53));
		objIndexPage.TopicDescription.sendKeys(Helper.getData("CreateEventPage", row, 90));
		Random rand = new Random();
		int n = rand.nextInt(5000) + 1;
		objIndexPage.EasySearchCode.sendKeys(Helper.getData("CreateEventPage", row, 91) + n);
		 //objIndexPage.TopicsSurveyDrpDwn(Helper.getData("CreateEventPage",row,
		 //56));
		
		objIndexPage.SponsorCompanyName.sendKeys(Helper.getData("CreateEventPage", row, 89));
...
//		objIndexPage.SponsorLogoImageCropBtn.click();
	...
	public void EventChallengePage(int row) throws Exception {
		...
		objIndexPage.ChallengeDescriptionTxtBx.sendKeys(Helper.getData("c", 2,6));
...
//		int n = rand.nextInt(5000) + 1;
		...
		// objIndexPage.selectSponsorDrpDwn(Helper.getData("EventChallengeJudge",2, 11));
		 ...
		 objIndexPage.selectAssignTicketDrpDwn(Helper.getData("EventChallengeJudge", 2, 15));
		 
		 String WinnerselectionCriteriaRadioBtn = Helper.getData("EventChallengeJudge", 2, 16);
...
//			objIndexPage.VideoLnk.clear();
	...
	public void SecondSponsorPresenter() throws Exception {
		...
		for (int i = 2; i <= 4; i++) 
			...
			Thread.sleep(2000);
			objIndexPage.SelectPresenterPhoneCode(Helper.getData("SponsorPresenter", 3, 6));
			
			objIndexPage.PresenterPhoneNumber.sendKeys(Helper.getData("SponsorPresenter", 3, 7));
			Thread.sleep(2000);
			objIndexPage.PresenterDesignation.sendKeys(Helper.getData("SponsorPresenter", 3, 8));
			objIndexPage.PrimaryContactChkBx(Helper.getData("SponsorPresenter", 2, 10));
			Thread.sleep(2000);
...
//		objIndexPage.SpeakerBtn.click();
	...
	public void ChallengeJudge() throws Exception {
		...
		//((JavascriptExecutor) driver).executeScript("scroll(0, 1000);");
			...
			objIndexPage.selectJudgecodeDrpdwn(Helper.getData("ChallengeJudge", 2, 6));
			objIndexPage.JudgeNumberTxtBx.sendKeys(Helper.getData("ChallengeJudge", 2, 7));
			 objIndexPage.JudgeJobTitleTxtBx.sendKeys(Helper.getData("ChallengeJudge", 2, 8));
			
			objIndexPage.selectJudgeAssignticketDrpDwn(Helper.getData("ChallengeJudge", 2, 9));
...
//	}
	...
	public void EventTicketsPage(int row) throws Exception {
		...
		((JavascriptExecutor) driver).executeScript("scroll(0, 0);");
		Thread.sleep(2000);
		objIndexPage.SalesStartDateTxtBx.sendKeys(Helper.getData("CreateEventPage", row, 59));
		objIndexPage.SalesStartDateTxtBx.click();
		objIndexPage.SalesEndDateTxtBx.sendKeys(Helper.getData("CreateEventPage", row, 60));
		objIndexPage.SalesEndDateTxtBx.click();
		objIndexPage.TicketsAllowPerOrderTxtBx.sendKeys(Helper.getData("CreateEventPage", row, 61));
		objIndexPage.TransactionChargesDrpDwn(Helper.getData("CreateEventPage", row, 62));
		objIndexPage.AllAttendeesRegisterChkBx.click();
		objIndexPage.LandingPageUrl.click();
		objIndexPage.LandingPageUrlTxtBx.sendKeys(Helper.getData("CreateEventPage", row, 65));
	
//		objIndexPage.RefundRadioBtn(Helper.getData("CreateEventPage", row, 66));

		String RefundRadioBtn = (Helper.getData("CreateEventPage", row, 66));
...

		{
			...
			Thread.sleep(2000);
			objIndexPage.selectRefundTypeDrpDwn(Helper.getData("CreateEventPage", row, 68));
			objIndexPage.RefundTypeTxtBx.sendKeys(Helper.getData("CreateEventPage", row, 69));
			objIndexPage.EventStartDateTxtBx.sendKeys(Helper.getData("CreateEventPage", row, 70));
			...
			objIndexPage.CancellationPolicyTxtBx.sendKeys(Helper.getData("CreateEventPage", row, 67));
		}
		...
		String AllTicketTypeDropDwn = Helper.getData("CreateEventPage", 2, 72);
